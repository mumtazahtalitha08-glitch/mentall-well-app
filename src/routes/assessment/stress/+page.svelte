	...
	const assessments = {
		en: {
			...
			questions: [
				{
					id: 1,
					text: 'I have been feeling overwhelmed by daily tasks',
					options: [
						{ value: 0, label: 'Never' },
				...
				{
					id: 2,
					text: 'I have trouble relaxing or unwinding after a stressful day',
					options: [
						{ value: 0, label: 'Never' },
						{ value: 1, label: 'Rarely' },
						{ value: 2, label: 'Sometimes' },
				...
				{
					id: 3,
					text: 'I feel irritable or short-tempered lately',
					options: [
						{ value: 0, label: 'Never' },
						{ value: 1, label: 'Rarely' },
						{ value: 2, label: 'Sometimes' },
				...
				{
					id: 4,
					text: 'I have difficulty concentrating on tasks',
					options: [
						{ value: 0, label: 'Never' },
						{ value: 1, label: 'Rarely' },
						{ value: 2, label: 'Sometimes' },
				...
				{
					id: 5,
					text: 'I experience physical symptoms like headaches or stomach aches due to stress',
					options: [
						{ value: 0, label: 'Never' },
						{ value: 1, label: 'Rarely' },
						{ value: 2, label: 'Sometimes' },
				...
				{
					id: 6,
					text: 'I feel like I have no control over the important things in my life',
					options: [
						{ value: 0, label: 'Never' },
						{ value: 1, label: 'Rarely' },
						{ value: 2, label: 'Sometimes' },
				...
				{
					id: 7,
					text: 'I find myself avoiding responsibilities or procrastinating more than usual',
					options: [
						{ value: 0, label: 'Never' },
						{ value: 1, label: 'Rarely' },
						{ value: 2, label: 'Sometimes' },
		...
		id: {
			...
			questions: [
				{
					id: 1,
					text: 'Saya merasa kewalahan dengan tugas-tugas sehari-hari',
					options: [
				...
				{
					id: 2,
					text: 'Saya mengalami kesulitan untuk rileks atau bersantai setelah hari yang penuh tekanan',
					options: [
						{ value: 0, label: 'Tidak pernah' },
						{ value: 1, label: 'Jarang' },
						{ value: 2, label: 'Kadang-kadang' },
				...
				{
					id: 3,
					text: 'Saya merasa mudah marah atau cepat emosi akhir-akhir ini',
					options: [
						{ value: 0, label: 'Tidak pernah' },
						{ value: 1, label: 'Jarang' },
						{ value: 2, label: 'Kadang-kadang' },
				...
				{
					id: 4,
					text: 'Saya mengalami kesulitan berkonsentrasi pada tugas-tugas',
					options: [
						{ value: 0, label: 'Tidak pernah' },
						{ value: 1, label: 'Jarang' },
						{ value: 2, label: 'Kadang-kadang' },
				...
				{
					id: 5,
					text: 'Saya mengalami gejala fisik seperti sakit kepala atau sakit perut akibat stres',
					options: [
						{ value: 0, label: 'Tidak pernah' },
						{ value: 1, label: 'Jarang' },
						{ value: 2, label: 'Kadang-kadang' },
				...
				{
					id: 6,
					text: 'Saya merasa tidak memiliki kendali atas hal-hal penting dalam hidup saya',
					options: [
						{ value: 0, label: 'Tidak pernah' },
						{ value: 1, label: 'Jarang' },
						{ value: 2, label: 'Kadang-kadang' },
				...
				{
					id: 7,
					text: 'Saya merasa menghindari tanggung jawab atau menunda-nunda lebih dari biasanya',
					options: [
						{ value: 0, label: 'Tidak pernah' },
						{ value: 1, label: 'Jarang' },
						{ value: 2, label: 'Kadang-kadang' },
	...
	function calculateResults() {
		...
		if (language === 'id') {
			...
			if (totalScore <= 7) {
				...
				recommendation = 'Anda memiliki tingkat stres yang rendah. Pertahankan gaya hidup sehat dan rutinitas yang baik.';
			} else if (totalScore <= 14) {
				interpretation = 'Stres Sedang';
				recommendation = 'Anda memiliki tingkat stres yang sedang. Pertimbangan untuk berlatih teknik relaksasi dan manajemen waktu.';
			} else if (totalScore <= 21) {
				interpretation = 'Stres Tinggi';
				recommendation = 'Anda memiliki tingkat stres yang tinggi. Disarankan untuk mencari dukungan dan mengembangkan strategi koping yang lebih baik.';
			} else {
				interpretation = 'Stres Sangat Tinggi';
				recommendation = 'Anda memiliki tingkat stres yang sangat tinggi. Sangat disarankan untuk segera mencari bantuan profesional.';
			}
		} else {
			// English interpretations
			if (totalScore <= 7) {
				interpretation = 'Low Stress';
				recommendation = 'You have a low level of stress. Maintain a healthy lifestyle and good routines.';
			} else if (totalScore <= 14) {
				interpretation = 'Moderate Stress';
				recommendation = 'You have a moderate level of stress. Consider practicing relaxation techniques and time management.';
			} else if (totalScore <= 21) {
				interpretation = 'High Stress';
				recommendation = 'You have a high level of stress. It is recommended to seek support and develop better coping strategies.';
			} else {
				interpretation = 'Very High Stress';
				recommendation = 'You have a very high level of stress. It is highly recommended to seek professional help immediately.';
			}
		}
...
<svelte:head>
	<title>{language === 'id' ? 'Tes Stres - MentalWell' : 'Stress Assessment - MentalWell'}</title>
</svelte:head>
	...
	<div class="max-w-4xl mx-auto space-y-6">
		...
		<div class="text-center">
			<h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">
				{language === 'id' ? 'Tes Stres' : 'Stress Assessment'}
			</h1>
		</div>
